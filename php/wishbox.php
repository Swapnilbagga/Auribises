...
//Form Datas
//You can set these tags with your HTML form's input names
$name = $_POST['name'];
$email = $_POST['email'];
$subject = $_POST['New Wishbox From Quadra'];
...
$mail->setFrom('noreply@example.com', 'Quadra Wishbox');
...
//Subject of e-mail
$mail->Subject = 'New Wishbox Message';
